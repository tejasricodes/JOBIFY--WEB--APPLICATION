  ...
  <body class="text-center">
    ...
    -->
      ...
      <main role="main" class="inner cover">
        <h1 class="cover-heading">Cover Page</h1>
...
if($query){
	echo "Profle Updated Successfully";
}
else{
...
move_uploaded_file(  $_FILES['img']['tmp_name'],'include/'.$img);
$query=mysqli_query($conn,"insert into profiles(img,name,dob,number,email,user_email)values('$img','$name','$dob','$number','$email','$user_email')");
...
?>
        ...
        <p class="lead">
          <a href="http://localhost/job_portal" class="btn btn-lg btn-secondary">Back to Portal</a>
        </p>
      </main>
