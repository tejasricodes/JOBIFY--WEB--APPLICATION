      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center text-md-left mb-5" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Job Application Desciption</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
        <div class="row">
          ...
          <div class="row">
             <div class="col-sm-6">
              <label for="fn">Enter Your Date of Birth</label>
              <input type="date" class="form-control"  name="dob" placeholder="Date of Birth...">
             </div>
             <div class="col-sm-6">
               <label for="ln">Choose Resume</label>
            ...
            <div class="row">
             <div class="col-sm-6">
              <label for="fn">Enter Your Contact Number</label>
         ...
         <div class="form-group">
          <input type="submit" name="submit" value="Apply" class="btn btn-primary btn-block">
</div>
           </form>
