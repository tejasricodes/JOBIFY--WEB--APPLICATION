...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        <a class="navbar-brand" href="index.php"><h1 style="color: white">Jobify</h1></a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <!-- < <li class="nav-item cta cta-colored"><a href="logout.php" class="nav-link">Logout</a></li>-->
              ...
              <img src="images/login.png" class="img-circle dropdown-toggle" type="button" data-toggle="dropdown" alt="Cinque Terre" width="50" height="50">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-xl-10 ftco-animate mb-5 pb-5" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">The right place <br><span>for your dream job or internship</span></h1>
                          ...
                          <div class="col-md">
                            <div class="form-group">
                              <div class="form-field">
                                ...
                                <input type="text" id="key" name="key" class="form-control" placeholder="eg. Graphic. Web Developer">
                              </div>
                            </div>
                          </div>
                          <div class="col-md">
            ...
            <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="mb-4 mb-md-0 mr-5">
                <div class="job-post-item-header d-flex align-items-center">
                  <h2 class="mr-3 text-black h3"><?php echo $row['job_tilte']; ?></h2>
                  <div class="badge-wrap">
                   <span class="bg-primary text-white badge py-2 px-3">Job</span>
                  </div>
                </div>
          ...
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                ...
                <p>Tons of opportunitites,easy and convinient search.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
          ...
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                ...
                <p>We make you realize your dream to reach the top of the corporate ladder.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                ...
                <p>Easy way of finding the right fit for your tailored job.</p>
              </div>
            </div>      
          </div>
        </div>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-4">Jobify is literally  the  best.</p>
                    <p class="name">Vaishnavi Annagiri</p>
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-4">I found my job here ,so very happy and delighted ,Jobify rocks.</p>
                    <p class="name">Tejasri Kondisetti</p>
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-4">Great tool to find your perfect job.</p>
                    <p class="name">Roger Scott</p>
        ...
        <div class="row d-flex">
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text mt-3">
                <div class="meta mb-2">
                  <div><a href="#">May 2, 2022</a></div>
                  <div><a href="#">Admin</a></div>
                  <div><a href="#" class="meta-chat"><span class="icon-chat"></span> 3</a></div>
                </div>
                <h3 class="heading"><a href="#">The best part about jobify</a></h3>
               <p>The jobify is the best website to find the persons for all the perfect jobs.</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text mt-3">
                ...
                <h3 class="heading"><a href="#">The best part about jobify</a></h3>
               <p>The jobify is the best website to find the persons for all the dream jobs..</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text mt-3">
                ...
                <h3 class="heading"><a href="#">The points that make jobify the most favourable website</a></h3>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li><span class="icon icon-map-marker"></span><span class="text">Gachibowli, Hyerabad, India</span></li>
                  <li><a href="#"><span class="icon icon-phone"></span><span class="text">9601191923</span></a></li>
                  <li><a href="#"><span class="icon icon-envelope"></span><span class="text">annagirivaishnavi@gmail.com</span></a></li>
                </ul>
              </div>
            </div>
          </div>
