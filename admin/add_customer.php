         ...
         <div style="width: 50%; margin-left: 20% ; background-color: gray">
          ...
          <form action="" method="post" name="customer_form" id="customer_form"> 
            ...
            <div class="form-group">
             ...
             <input type="email" class="form-control" name="email" id="email" placeholder="Enter the Customer email id">

            </div>
             <div class="form-group">
             <label for="Customer Username"></label>
             <input type="text" class="form-control" name="Username" id="Username" placeholder="Enter the Customer Username ">
            ...
            <select name="admin_type" name="admin_type" id="admin_type" class="form-control">
