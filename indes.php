      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-xl-10 ftco-animate mb-5 pb-5" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">The right place <br><span>for your dream job</span></h1>
                          ...
                          <div class="col-md">
                            <div class="form-group">
                              <div class="form-field">
                                ...
                                <input type="text" id="key" name="key" class="form-control" placeholder="eg. Garphic. Web Developer">
                              </div>
                            </div>
                          </div>
                          <div class="col-md">
